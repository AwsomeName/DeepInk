...
> 状态：基础 Markdown 编辑与 Agent 双向通信已实现；Markdown S 级仍在开发规划阶段。
...
| 格式               | 当前编辑       | 当前预览     | 当前事实                                                     |
| ------------------ | -------------- | ------------ | ------------------------------------------------------------ |
| `.md`, `.markdown` | 基础富文本编辑 | 所见即所得   | 已有 Tiptap 基础能力，尚缺保真、源码模式、冲突处理和选区引用 |
...
Markdown S 级将补齐双模式、保真保护、完整图片和表格交互、保存冲突以及选区带行号发送到会话。AI 行内改写、翻译、续写等能力属于后续专项，不纳入本轮 S 级验收。
...
产品边界、源码模式、保真、选区行号引用、保存安全和里程碑统一见
