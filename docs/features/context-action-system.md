...
- 2026-07-22 实现提交 `000bf69` 已在全新 detached worktree 通过 `pnpm install --frozen-lockfile`、`pnpm verify`（155 files / 937 tests）和 `pnpm smoke:standalone`（local 9/9、UI 6/6、workflow 9/9、restore 4/4）；H1-H5 真人验收仍待完成。
