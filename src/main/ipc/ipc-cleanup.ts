...
const IPC_HANDLE_CHANNELS = [
  ...
  'subscription:checkOrder',
  'subscription:verifyAppleIap',
  'subscription:cancel',
  // sync-ipc
  'sync:getStatus',
  'sync:getConfig',
  ...
  'cclink:getState',
  'cclink:getIdentity',
  'cclink:preflightLegacyImport',
  'cclink:ensureIdentity',
  'cclink:clearIdentity',
  'cclink:sendLegacySmsCode',
  'cclink:importLegacyIdentity',
  'cclink:listServers',
  'cclink:removeServer',
  'cclink:listSessions',
  'cclink:syncPairedAgents',
  'cclink:removeSession',
  'cclink:listMessages',
  'cclink:sendLocalMessage',
  'cclink:listFileTree',
  'cclink:readFile',
  'cclink:getRealtimeStatus',
  'cclink:connectRealtime',
  'cclink:disconnectRealtime',
  'cclink:clearLocalData',
  'cclink:seedDemoData',
  // remote-ipc
  'remote:getStatus',
