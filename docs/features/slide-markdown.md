# DeepInk Slide Markdown — 轻量幻灯片格式方案
...
DeepInk 已经具备 Markdown 文档编辑基础能力。下一步如果要支持“做 PPT”，不一定要复刻 PowerPoint 的完整文件格式和交互模型，而可以设计一种更适合 AI 生成、用户轻量编辑、文本可读、跨端渲染的新格式。
...
DeepInk Slide Markdown 是一种内容驱动的幻灯片格式。
...
| 维度 | 传统 PPT | DeepInk Slide Markdown |
|------|----------|------------------------|
| 核心模型 | 画布对象 | 内容块 + 语义版式 |
...
:::notes
这一页用于解释产品定位，重点强调 DeepInk 是工作入口，而不是单点 AI 工具。
:::
```
