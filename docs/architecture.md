...
核心体验页面的职责边界见 `docs/features/product-experience-pages.md`；工作空间信息架构见 `docs/features/project-system.md`；Agent 会话、资源挂载和历史管理模型见 `docs/features/agent-system.md`。
...
macOS Keychain (DeepInk)      # 认证 Token + WebDAV 密码 + 未来扩展凭据
```
