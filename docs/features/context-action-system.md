...
- 2026-07-22 M5 实现基线已在全新 detached worktree 通过 `pnpm install --frozen-lockfile`、`pnpm verify`（155 files / 937 tests）和 `pnpm smoke:standalone`（local 9/9、UI 6/6、workflow 9/9、restore 4/4）；焦点时序修正后的最新提交必须在推送前重跑同一组门禁，H1-H5 真人验收仍待完成。
