...
export function IconFiles(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <path d="M2 3.5A1.5 1.5 0 0 1 3.5 2h2.086a1 1 0 0 1 .707.293l.707.707H12.5A1.5 1.5 0 0 1 14 4.5v8a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 12.5v-9z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/>
    </>
  ))
}
...
export function IconGlobe(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M2.5 8h11M3 5.5h10M3 10.5h10" stroke="currentColor" strokeWidth="0.8" opacity="0.6"/>
    </>
  ))
}
...
export function IconSettings(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M8 1.5v2M8 12.5v2M1.5 8h2M12.5 8h2M3.05 3.05l1.41 1.41M11.54 11.54l1.41 1.41M3.05 12.95l1.41-1.41M11.54 4.46l1.41-1.41" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
    </>
  ))
}
...
export function IconUser(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M3.2 14c.5-2.8 2.3-4.2 4.8-4.2s4.3 1.4 4.8 4.2" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round"/>
    </>
  ))
}
...
export function IconFolder(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <path d="M1.5 3.5A1 1 0 0 1 2.5 2.5h3l1.5 1.5h6.5a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-11a1 1 0 0 1-1-1v-8.5z" stroke="currentColor" strokeWidth="1.1" strokeLinejoin="round"/>
  ))
}

export function IconFile(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <path d="M4 1.5h5.5L13 5v9.5a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-13a1 1 0 0 1 1-1z" stroke="currentColor" strokeWidth="1.1" strokeLinejoin="round"/>
  ))
}
...
export function IconRefresh(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <path d="M13.5 8A5.5 5.5 0 1 1 8 2.5M13.5 2.5v3h-3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
  ))
}
...
export function IconZoomIn(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <circle cx="6.5" cy="6.5" r="4" stroke="currentColor" strokeWidth="1.2" />
      <path d="M9.5 9.5L14 14M4.5 6.5h4M6.5 4.5v4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    </>
  ))
}
...
export function IconZoomOut(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <circle cx="6.5" cy="6.5" r="4" stroke="currentColor" strokeWidth="1.2" />
      <path d="M9.5 9.5L14 14M4.5 6.5h4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    </>
  ))
}
...
export function IconFitWidth(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M4.5 5.5L2 8l2.5 2.5M11.5 5.5L14 8l-2.5 2.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M2 3v10M14 3v10" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity="0.5" />
    </>
  ))
}
...
/** 状态圆点 */
export function IconCircle({ filled, color, ...p }: IconProps & { filled?: boolean; color?: string }): React.ReactElement {
  const s = p.size ?? 16
  const r = filled ? 5 : 5
  return (
    <svg width={s} height={s} viewBox="0 0 16 16" fill="none" className={p.className} style={p.style}>
      <circle
        cx="8" cy="8" r={r}
...
export function IconLink(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <path d="M6.5 9.5l3-3M9 11l1.5-1.5a3 3 0 0 0-4.24-4.24L5 6.5M7 5L5.5 6.5a3 3 0 0 0 4.24 4.24L11 8.5" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round"/>
    </>
  ))
}
...
export function IconRobot(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M8 2v3M5 3l1.5 2M11 3l-1.5 2" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round"/>
    </>
  ))
}
...
export function IconDollar(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M11.5 4.5H6.75a2.25 2.25 0 0 0 0 4.5h2.5a2.25 2.25 0 0 1 0 4.5H4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
    </>
  ))
}
...
export function IconBookmark(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <path d="M3 2.5A1.5 1.5 0 0 1 4.5 1h7A1.5 1.5 0 0 1 13 2.5v12L8 11l-5 3.5v-12z" stroke="currentColor" strokeWidth="1.1" strokeLinejoin="round"/>
  ))
}
...
export function IconPaintbrush(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <path d="M12 2L6.5 7.5M12 2l2 2-5.5 5.5M12 2L10 4" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M5.5 7.5C4 9 3 12 3 13c1 0 4-1 5.5-2.5" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round"/>
    </>
  ))
}
...
export function IconKeyboard(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M4 7h1M7 7h1M10 7h1M4 10h8" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round"/>
    </>
  ))
}
...
export function IconSparkle(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <path d="M8 1l1.5 5.5L15 8l-5.5 1.5L8 15l-1.5-5.5L1 8l5.5-1.5L8 1z" stroke="currentColor" strokeWidth="1.0" strokeLinejoin="round" fill="none"/>
    </>
  ))
}
...
export function IconThinking(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      ...
      <path d="M5.5 11.5c0 1 1 2.5 2.5 2.5s2.5-1.5 2.5-2.5" stroke="currentColor" strokeWidth="1.0" strokeLinecap="round"/>
...
export function IconTool(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <path d="M13.5 4.5l-2 2-2-2 2-2a3.5 3.5 0 0 0-4 4.5L3 9.5a1.5 1.5 0 0 0 2 2L9.5 7a3.5 3.5 0 0 0 4-2.5z" stroke="currentColor" strokeWidth="1.0" strokeLinejoin="round"/>
    </>
  ))
}
...
export function IconCheck(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <path d="M3.5 8.5l3 3 6-7" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
  ))
}
...
export function IconCloud(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <path d="M4.5 11.5a3 3 0 0 1-.27-5.98A4.5 4.5 0 0 1 12 6.5a2.5 2.5 0 0 1 .5 4.95V11.5H4.5z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/>
  ))
}
...
export function IconSync(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <path d="M2.5 8A5.5 5.5 0 0 1 12 4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M13.5 8A5.5 5.5 0 0 1 4 12" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M12 1.5V4h2.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M4 14.5V12H1.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
    </>
  ))
}
...
export function IconCloudCheck(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <>
      <path d="M4.5 11.5a3 3 0 0 1-.27-5.98A4.5 4.5 0 0 1 12 6.5a2.5 2.5 0 0 1 .5 4.95V11.5H4.5z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/>
      <path d="M6 9l1.5 1.5L10 7.5" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round"/>
    </>
  ))
}
...
export function IconCrown(p: IconProps = defaults): React.ReactElement {
  return I(p, (
    <path d="M2 11L3.5 4.5L6 7L8 3L10 7L12.5 4.5L14 11H2z" stroke="currentColor" strokeWidth="1.1" strokeLinejoin="round" strokeLinecap="round"/>
  ))
}
