...
export function createViewCommands(deps: ViewCommandDeps): Command[] {
  return [
    { id: 'workbench.toggleSidebar', label: '切换侧栏', shortcut: '⌘ B', category: '视图', action: deps.toggleSidebar },
    { id: 'workbench.toggleAgentPanel', label: '切换 Agent 面板', shortcut: '⌘ J', category: '视图', action: deps.toggleAgentPanel },
    { id: 'workbench.focusAgentPanel', label: '专注 Agent 对话', shortcut: '⌘ ⇧ J', category: '视图', action: deps.focusAgentPanel },
    { id: 'workbench.resetAgentLayout', label: '重置 Agent 布局', category: '视图', action: deps.resetAgentLayout },
    {
      id: 'view.zoomIn',
      label: '放大界面',
      category: '视图',
